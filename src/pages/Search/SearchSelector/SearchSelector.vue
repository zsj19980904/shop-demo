<template>
	<div class="clearfix selector">
		...
		<div class="type-wrap" v-for="(attr,inde) in attrsList" :key="attr.attrId">
	...
	export default {
		...
		methods:{
			...
			trademarkHandler(trademark){
				//这里为什么要把数据带个父组件？因为trademark在父组件上面,并且是通过请求得来的数据，因此在点击品牌列表的时候，需要传递给父元素---自定义事件
				//触发自定义事件,把点击品牌的信息传递给trademarkInfo这个参数
