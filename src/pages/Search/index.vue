		...
		methods: {
			...
			removecategor() {
				...
				if (this.$route.params) {
					//本意是删除query，如果路由中出现了params不应该删除的，路由跳转的时候应该带上
					this.$router.push({
						name: 'search',
			...
			changeOrder(flag) {
				//获取最初始的状态
				let origiOrder=this.searchParams.order;
				//确定order中的数字
